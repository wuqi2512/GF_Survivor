...
public partial class DialogForm : UGuiForm
{
    [SerializeField]
    ...
    protected override void OnInit(object userData)
    {
        ...
        m_Btn_Confirm1.OnClick += OnConfirmButtonClick;
        m_Btn_Confirm2.OnClick += OnConfirmButtonClick;
        m_Btn_Confirm3.OnClick += OnConfirmButtonClick;
        m_Btn_Cancel2.OnClick += OnCancelButtonClick;
        m_Btn_Cancel3.OnClick += OnCancelButtonClick;
        m_Btn_Other3.OnClick += OnOtherButtonClick;
    }
    ...
    protected override void OnOpen(object userData)
    {
        ...
        m_TxtP_Title.text = dialogParams.Title;
        m_TxtP_Message.text = dialogParams.Message;
    ...
    protected override void OnClose(bool isShutdown, object userData)
    {
        ...
        m_DialogMode = 1;
        m_TxtP_Title.text = string.Empty;
        m_TxtP_Message.text = string.Empty;
        m_PauseGame = false;
        m_UserData = null;
