...
namespace StarForce
{
    public class HPBarItem : MonoBehaviour
    {
        ...
        private EntityLogicWithData m_Owner = null;
        private int m_OwnerId = 0;

        public EntityLogicWithData Owner
        {
            get
            {
                return m_Owner;
        ...
        public void Init(EntityLogicWithData owner, Canvas parentCanvas, float fromHPRatio, float toHPRatio)
        {
            if (owner == null)
            {
