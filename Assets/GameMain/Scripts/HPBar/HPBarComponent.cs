...
namespace StarForce
{
    public class HPBarComponent : GameFrameworkComponent
    {
        ...
        public void ShowHPBar(EntityLogicWithData entity, float fromHPRatio, float toHPRatio)
        {
            if (entity == null)
            {
        ...
        private HPBarItem GetActiveHPBarItem(EntityLogicWithData entity)
        {
            if (entity == null)
            {
                return null;
        ...
        private HPBarItem CreateHPBarItem(EntityLogicWithData entity)
        {
